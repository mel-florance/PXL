...
void Viewport::addCube(const CallbackData & data)
{
...
void Viewport::createCube(const CallbackData & data)
{
...
void Viewport::onCreateCubeModalClosed(const CallbackData & data)
{
...
void Viewport::onKeyUp(const SDL_Event & event) {

	if (event.key.keysym.sym == SDLK_F11) 
		m_mode = m_mode == GAME ? EDITOR : GAME;
}
