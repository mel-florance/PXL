...
int main(int argc, char* argv[]) 
{
	...
	Transform plane_transform(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(5.0f, 5.0f, 5.0f));
	...
	while (!window->isClosed())
	{
		...
		shader->update(ak_transform, camera, light);
		ak_texture.bind(0);
		ak.draw();

		shader->update(monkey_transform, camera, light);
